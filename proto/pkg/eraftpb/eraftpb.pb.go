...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e3380f13b17a2ccb, []int{0}
}
...
func (MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e3380f13b17a2ccb, []int{1}
}
...
func (ConfChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e3380f13b17a2ccb, []int{2}
}
...
type Message struct {
	...
	PrevIndex            uint64      `protobuf:"varint,11,opt,name=prevIndex,proto3" json:"prevIndex,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e3380f13b17a2ccb, []int{3}
}
...
func (m *Message) GetPrevIndex() uint64 {
	if m != nil {
		return m.PrevIndex
	}
	return 0
...
func (*HardState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e3380f13b17a2ccb, []int{4}
}
...
func (*ConfState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e3380f13b17a2ccb, []int{5}
}
...
func (*ConfChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e3380f13b17a2ccb, []int{6}
}
...
func (m *Message) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PrevIndex != 0 {
		dAtA[i] = 0x58
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.PrevIndex))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Message) Size() (n int) {
	...
	if m.PrevIndex != 0 {
		n += 1 + sovEraftpb(uint64(m.PrevIndex))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func init() { proto.RegisterFile("eraftpb.proto", fileDescriptor_eraftpb_e3380f13b17a2ccb) }

var fileDescriptor_eraftpb_e3380f13b17a2ccb = []byte{
	// 679 bytes of a gzipped FileDescriptorProto
	,
}
